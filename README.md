...
- [aopalliance](https://github.com/aopalliance/aopalliance) *(AOP interoperability)*
- [backport-util-concurrent](https://github.com/dmlloyd/backport-util-concurrent) *(Concurrency backport)*
- [cglib](https://github.com/cglib/cglib) *(Code Generation Library)*
...
- [commons-httpclient](https://github.com/apache/commons-httpclient)
...
- [joda-time](https://github.com/JodaOrg/joda-time) *(Date/Time utility)*

### XML, Parsing & Web Templating
- [antlr](https://github.com/antlr/antlr4) *(Parser generator)*
...
- [xerces](https://github.com/apache/xerces2-j) *(XML parser)*
- [xml-apis](https://github.com/apache/xml-apis) *(XML APIs)*
- [xmlpull](https://github.com/xmlpull/xmlpull) *(XML Pull Parsing)*
- [xom](https://github.com/elharo/xom) *(XML Object Model)*
- [xpp3](https://github.com/cybernel/xpp3) *(XML Pull Parser 3)*

### Logging & Core Frameworks
- [avalon-framework](https://github.com/apache/avalon) *(Container framework)*
- [classworlds](https://github.com/codehaus-plexus/classworlds) *(Classloader framework)*
...
- [mysql](https://github.com/mysql/mysql-connector-j) *(MySQL JDBC driver)*
...
- [net](https://github.com/search?q=java+maven+net) *(Generic top-level namespace)*
- [spring](https://github.com/spring-projects/spring-framework) *(e.g., org.springframework)*
...
- [Nix](https://github.com/bbenoist/vscode-nix)
...
- [PHP](https://github.com/DEVSENSE/phptools-docs)
- [Docker DX](https://github.com/docker/vscode-extension)
- [XML Tools](https://github.com/DotJoshJohnson/vscode-xml)
- [C#](https://github.com/dotnet/vscode-csharp)
- [.NET Install Tool](https://github.com/dotnet/vscode-dotnet-runtime)
- [Dprint Code Formatter](https://github.com/dprint/dprint-vscode)
...
- [Mithril Emmet](https://github.com/FallenMax/mithril-emmet)
- [Dependi](https://github.com/filllabs/dependi)
- [Debugger for Firefox](https://github.com/firefox-devtools/vscode-firefox-debug)
- [shell-format](https://github.com/foxundermoon/vs-shell-format)
- [Kotlin](https://github.com/fwcd/vscode-kotlin)
...
- [GraphQL: Language Feature Support](https://github.com/graphql/graphiql)
- [HashiCorp Terraform](https://github.com/hashicorp/vscode-terraform)
- [Prettier ESLint](https://github.com/idahogurl/vs-code-prettier-eslint)
- [Size Tree](https://github.com/jackiotyu/size-tree)
- [SSH Config Enhanced](https://github.com/jamief/vscode-ssh-config-enhanced)
- [Edit CSV](https://github.com/janisdd/vscode-edit-csv)
- [Better C++ Syntax](https://github.com/jeff-hykin/better-cpp-syntax)
- [CodeGraphy](https://github.com/joesobo/CodeGraphyV4)
- [Twitch Chat](https://github.com/kamerat/vs-code-twitch-chat)
- [Python Indent](https://github.com/kbrose/vsc-python-indent)
- [CodeSnap](https://github.com/kufii/CodeSnap)
- [Blockman - Highlight Nested Code Blocks](https://github.com/leodevbro/vscode-blockman)
- [jsdoc](https://github.com/lllllllqw/vscode-jsdoc)
- [nixfmt](https://github.com/mariatsji/ormolu-vscode)
- [PDF Viewer](https://github.com/mathematic-inc/vscode-pdf)
- [Kotlin Language](https://github.com/mathiasfrohlich/vscode-kotlin)
- [MDX](https://github.com/mdx-js/mdx-analyzer)
- [Rainbow CSV](https://github.com/mechatroner/vscode_rainbow_csv)
- [Git Graph](https://github.com/mhutchie/vscode-git-graph)
- [Pylance](https://github.com/microsoft/pylance-release)
- [VS Code Speech](https://github.com/microsoft/vscode)
- [CMake Tools](https://github.com/microsoft/vscode-cmake-tools)
- [Container Tools](https://github.com/microsoft/vscode-containers)
...
- [Project Manager for Java](https://github.com/Microsoft/vscode-java-dependency)
- [Extension Pack for Java](https://github.com/Microsoft/vscode-java-pack)
- [Test Runner for Java](https://github.com/Microsoft/vscode-java-test)
...
- [Makefile Tools](https://github.com/Microsoft/vscode-makefile-tools)
...
- [Python Environments](https://github.com/microsoft/vscode-python-environments)
...
- [SSH Config Syntax Highlighter](https://github.com/mousavian/ssh-config-syntax-highlighter)
- [Go Doc](https://github.com/msyrus/vscode-go-doc)
...
- [Open in New Window](https://github.com/onatm/open-in-new-window)
- [Protobuf (Protocol Buffers)](https://github.com/pbkit/vscode-pbkit)
- [PowerShell](https://github.com/PowerShell/vscode-powershell)
- [Prettier - Code: formatter](https://github.com/prettier/prettier-vscode)
- [Prisma](https://github.com/prisma/language-tools)
- [TypeScript Language Server Live Reload](https://github.com/rbuckton/tsserver-live-reload)
- [Language Support for Java(TM) by Red Hat](https://github.com/redhat-developer/vscode-java)
- [Community Server Connectors](https://github.com/redhat-developer/rsp-server-community)
- [Runtime Server Protocol UI](https://github.com/redhat-developer/vscode-rsp-ui)
- [XML](https://github.com/redhat-developer/vscode-xml)
- [YAML](https://github.com/redhat-developer/vscode-yaml)
- [Live Server](https://github.com/ritwickdey/vscode-live-server)
- [rust-analyzer](https://github.com/rust-lang/rust-analyzer)
- [just](https://github.com/skellock/vscode-just)
- [Prettier SQL VSCode](https://github.com/sql-formatter-org/sql-formatter)
- [Code: Spell Checker](https://github.com/streetsidesoftware/vscode-spell-checker)
- [Tree](https://github.com/structure-codes/vscode-tree-language)
...
- [Tauri](https://github.com/tauri-apps/tauri-vscode)
...
- [Automatic Comment Blocks](https://github.com/ycodetech/auto-comment-blocks)
- [git-config Language Server](https://github.com/yy0931/gitconfig-lsp)
